...
const value = '1'
console.log(typeof value == "string" ? "Es un string":typeof value == "number"? "Es un numero":"No es ni número ni string" );
...
//'0: Ada Lovelace, su aporte fue la máquina analítica'. 
 ...
 */
//`${var}`	Insert variable into string (template)

let text = "";
for (let i in programmers){ 
    const programmer = programmers[i];
    text += i + ":" + programmer.name + " " + programmer.lastname + " su aporte fue " + programmer.knowledge + ".\n";
}
// \n for line breaks if printing multiple lines in the console.
console.log(text)
